...
const ICON_PATHS = {
  ...
  zap: '<circle cx="8" cy="8" r="6"/><path d="M8.6 4.8 6 8.6h2l-.6 2.6L10 7.4H8l.6-2.6Z" fill="currentColor" stroke="none"/>',
  paperclip:
    '<path d="M11.2 4.2 5.6 9.8a2.3 2.3 0 0 0 3.3 3.3l5.6-5.6a3.7 3.7 0 0 0-5.2-5.2L3.7 7.9a5.1 5.1 0 0 0 7.2 7.2"/>',
  sparkle:
    '<path d="M8 1.5c.4 2.3 1.3 3.6 3.3 4.2-2 .6-2.9 1.9-3.3 4.2-.4-2.3-1.3-3.6-3.3-4.2 2-.6 2.9-1.9 3.3-4.2Z" fill="currentColor" stroke="none"/><path d="M12.8 9.5c.25 1.1.7 1.7 1.7 2-1 .3-1.45.9-1.7 2-.25-1.1-.7-1.7-1.7-2 1-.3 1.45-.9 1.7-2Z" fill="currentColor" stroke="none"/>',
  camera:
